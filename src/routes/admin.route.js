...
router.get("/callback", passport.authenticate('admin', { successRedirect:"https://erda-membership-management.netlify.com/",failureRedirect: 'https://erda-membership-management.netlify.com/api/error' }), adminController.logIn)
